      ...
      >
        ...
        <div className="p-4">
          <div
            ...
            onDrop={onDrop}
            className={`relative flex h-64 w-full cursor-pointer items-center justify-center rounded-lg border-2 border-dashed ${
              isDragging ? 'border-blue-400 bg-blue-950' : 'border-gray-500'
        ...
        <div className="flex items-center justify-between px-4 py-2">
          ...
          <div className="flex items-center gap-2">
            <Switch
              ...
              className={`${formData.status === 'Closed' ? 'bg-red-600' : 'bg-green-600'} relative inline-flex h-6 w-11 items-center rounded-full transition`}
            >
              <span
                className={`${formData.status === 'Closed' ? 'translate-x-6' : 'translate-x-1'} inline-block h-4 w-4 transform rounded-full bg-white transition`}
              />
            </Switch>
            <span className="text-sm text-gray-300">{formData.status === 'Closed' ? 'Closed' : 'Open'}</span>
          </div>
        </div>
